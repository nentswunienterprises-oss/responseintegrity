...
COMMENT ON TABLE specialist_capability_assessment_attempts IS
  'Immutable evidence for deterministic Specialist capability assessments. Direct client access is denied; feature-branch capability evidence does not replace Battle Test progression.';
