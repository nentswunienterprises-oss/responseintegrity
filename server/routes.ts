Warning: truncated output (original token count: 252631)
Total output lines: 26044
  ...
  app.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const trainingSessionInsertResult: an…52631 tokens truncated…         tutorId: assignment.tutorId,
              tutorName: tutor?.name || tutor?.firstName || "Unknown Tutor",
              tutorEmail: tutor?.email || "",
              studentCount: students.length,
            };
