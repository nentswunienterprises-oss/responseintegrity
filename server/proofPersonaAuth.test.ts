...
import { isPreviewProofPersonaEmail } from "./emergencyAuth";
...
test("Preview proof persona fallback remains Preview-only and credential-backed", () => {
  ...
  assert.match(fallback, /isPreviewProofPersonaEmail\(normalizedEmail\)/);
