...
test("multi-lead parent history preserves the earliest Production Link and rejects reassignment", () => {
  ...
  assert.throws(
    () => resolveDurableProductionLink(lead?.production_link_code, null, "DEM002"),
